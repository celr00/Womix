...
namespace API.SignalR
{
    ...
    public class MessageHub : Hub
    {
        ...
        public MessageHub(IUnitOfWork uow, IMapper mapper, IHubContext<PresenceHub> presenceHub, UserManager<AppUser> userManager)
        {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            else
            {
                ...
                if (connections != null)
                {
                    await _presenceHub.Clients.Clients(connections).SendAsync("NewMessageReceived",
                        new {username = sender.UserName, knownAs = sender.Email});
                }
            }
            ...
            {
                await Clients.Group(groupName).SendAsync("NewMessage", _mapper.Map<Core.Dtos.MessageDto>(message));
            }
        }
