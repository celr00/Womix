        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppUserAddresses_Address_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserPhotos", x => new { x.PhotoId, x.UserId });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppUserPhotos_Photos_PhotoId",
                        column: x => x.PhotoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductItemClasses", x => new { x.ProductId, x.ItemClassId });
                    table.ForeignKey(
                        name: "FK_ProductItemClasses_ItemClasses_ItemClassId",
                        column: x => x.ItemClassId,
                        principalTable: "ItemClasses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductItemClasses_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPhotos", x => new { x.PhotoId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProducts", x => new { x.OwnerId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_UserProducts_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicePhotos", x => new { x.PhotoId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_ServicePhotos_Photos_PhotoId",
                        column: x => x.PhotoId,
                        principalTable: "Photos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductItemClasses_ItemClassId",
                table: "ProductItemClasses",
                column: "ItemClassId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductItemClasses_ProductId",
                table: "ProductItemClasses",
                column: "ProductId",
                unique: true);
