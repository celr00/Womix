...
{
    public class JobsWithUserJobInterestSpecification : BaseSpecification<Job>
    {
        public JobsWithUserJobInterestSpecification(JobSpecParams jobParams)
            : base(x =>
        ...
        public JobsWithUserJobInterestSpecification(int id) : base(x => x.Id == id)
        {
            AddInclude(x => x.UserJobInterests);
            AddInclude(x => x.JobArea);
        }
